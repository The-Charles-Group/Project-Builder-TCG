...
_CANONICAL = {"gpt-5": "gpt-5", "gpt-5-pro": "gpt-5-pro", "gpt-5-mini": "gpt-5-mini",
              "gpt-5-thinking": "gpt-5", "gpt-5-thinking-mini": "gpt-5-mini"}

# Tier → model + effort
_TIER_TO_MODEL = {"mini": "gpt-5-mini", "thinking": "gpt-5", "pro": "gpt-5-pro",
                  "fast": "gpt-5-mini", "balanced": "gpt-5", "accurate": "gpt-5-pro"}
...
class _GuardedOpenAI(_OpenAI):  # type: ignore[misc]
    ...
    class _ResponsesProxy:
        ...
        def create(self, **kwargs: Any):
            ...
            if mot is not None: kwargs["max_output_tokens"] = int(mot)
            kwargs["reasoning"] = {"effort": _effort_for(model, kwargs)}
            return self._outer._raw.responses.create(**kwargs)
...
class _GuardedAsyncOpenAI(_AsyncOpenAI):  # type: ignore[misc]
    ...
    class _ResponsesProxy:
        ...
        async def create(self, **kwargs: Any):
            ...
            if mot is not None: kwargs["max_output_tokens"] = int(mot)
            kwargs["reasoning"] = {"effort": _effort_for(model, kwargs)}
            return await self._outer._raw.responses.create(**kwargs)
