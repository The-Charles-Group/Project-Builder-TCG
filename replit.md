...
- **GPT 5.2 Pro Additional Fixes (Dec 2025)**: (1) Business-day shifting in compress_deliverable_timeline uses add_business_days() instead of timedelta(days=) to prevent tasks landing on weekends; (2) MSPDI header fields SaveVersion, Title, Author added before <Name> element as required by Workfront.
