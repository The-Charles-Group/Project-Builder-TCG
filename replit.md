...
- **Phase-Window Scheduling**: Feature-flagged system (PHASE_WINDOW_ENABLED) that splits component windows into general (50%), internal_review (30%), and client_review (20%) phases with minimum 1 business day each, eliminating work-wait-work gaps. Short components (<3 days) get full window allocation.
