...
def post_process_xml(input_xml_path: str) -> str:
    ...
    try:
        ...
        print(f"[XML post-process] Returning original file without parallelization")
    ...
    try:
        ...
        print(f"[XML post-process] Post-processing failed: {e}")
        print(f"[XML post-process] Returning original file")
        return input_xml_path
