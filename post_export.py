...
def post_process_xml(input_xml_path: str) -> str:
    """
    Post-process XML to remove same-name predecessor links, enabling parallel execution
    of tasks with identical names (e.g., multiple "Examples per Pillar" tasks).
    """
